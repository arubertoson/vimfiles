...
" Environment Variables:
  ...
  let g:python_host_prog = resolve(expand('$_BASE_OPT/conda/base/envs/nvim2')) . '/bin/python2'
  let g:python3_host_prog = resolve(expand('$_BASE_OPT/conda/base/envs/nvim3')) . '/bin/python3'
